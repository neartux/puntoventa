                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.name.$invalid && !userForm.name.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="name" data-ng-model="ctrl.userTO.name"
                                               class="form-control" id="name" required maxlength="50">
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.address.$invalid && !userForm.address.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="address" data-ng-model="ctrl.userTO.address"
                                               class="form-control" required id="address" maxlength="50">
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.last_name.$invalid && !userForm.last_name.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="last_name" data-ng-model="ctrl.userTO.last_name"
                                               class="form-control" required id="last_name" maxlength="50">
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.cell_phone.$invalid && !userForm.cell_phone.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="cell_phone" data-ng-model="ctrl.userTO.cell_phone"
                                               class="form-control" required id="cell_phone" maxlength="50">
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.email.$invalid && !userForm.email.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="email" data-ng-model="ctrl.userTO.email"
                                               class="form-control" required id="email" maxlength="50">
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.user_name.$invalid && !userForm.user_name.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="user_name" data-ng-model="ctrl.userTO.user_name"
                                               class="form-control" required id="user_name" maxlength="30">
                                        <span ng-show="userForm.user_name.$invalid && !userForm.user_name.$pristine"
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.password.$invalid && !userForm.password.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="password" data-ng-model="ctrl.userTO.password"
                                               class="form-control" required id="password" maxlength="50">
                                ...
                                <div class="form-group" ng-class="{ 'has-error' : userForm.password_confirmation.$invalid && !userForm.password_confirmation.$pristine }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="password_confirmation" data-ng-model="ctrl.userTO.password_confirmation"
                                               class="form-control" required id="password_confirmation" maxlength="50">
